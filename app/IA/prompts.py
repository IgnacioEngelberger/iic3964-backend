SYSTEM = (
  ...
  "para evaluar Ley de Urgencia (riesgo de muerte o secuela funcional grave que requiera "
  "atención inmediata e impostergable). Devuelve EXCLUSIVAMENTE JSON válido."
)
...
SYSTEM_STRICT = SYSTEM + (
    ...
    '\n    {"label":"str","url":"str","snippet":"str","section":"urgency|diagnosis_top|actions|general"}'
    "\n  ]\n}\n"
)
...
2) urgency_flag: "applies" si hay riesgo vital/secuela grave que requiere atención inmediata; "does_not_apply" si no; "uncertain" si falta info.
