"""
Prompt templates for Gemini clinical-legal reasoning.
"""
...
SYSTEM = (
    ...
    "requiera atención inmediata e impostergable). Devuelve EXCLUSIVAMENTE JSON "
    "válido."
)
...
2) urgency_flag: "applies" si hay riesgo vital/secuela grave que requiere atención
   inmediata; "does_not_apply" si no; "uncertain" si falta info.
